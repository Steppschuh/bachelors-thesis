...
\begin{figure}[H]
	...
	\caption[Caption for activity_lifecycle]{Activity lifecycle states\footnotemark}
	\label{fig:activityLifecycle}
\end{figure}
\footnotetext{https://developer.android.com/reference/android/app/Activity.html}

The following very basic example activity would print accelerometer data to the console once deployed.
